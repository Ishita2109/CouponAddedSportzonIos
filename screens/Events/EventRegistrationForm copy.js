...
import { View, Text, TextInput, TouchableOpacity, Image, ScrollView, ImageBackground, Animated} from 'react-native';
...
const EventRegistrationForm = ({ route }) => {
   ...
   // const {planDetails} = route.params;
    ...
    return (
        <ScrollView style={{ flex: 1, backgroundColor: "#F8F9FD", padding: 20 }}>
           {/* Event Details */}
      ...
      <View style={{ backgroundColor: "white", padding: 15, borderRadius: 10, marginBottom: 15 }}>
        ...
        <Text style={{ color: "#666" }}>Full Nam*</Text>
        ...
        <TextInput style={{ borderWidth: 1, borderColor: "#ccc", borderRadius: 8, padding: 8, marginBottom: 10 }} value="" />
      </View>
