...
const CorporateMembershipScreen = ({route}) => {
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ backgroundColor: '#C71585', height:250, padding: 20,  position: 'relative' }}>
          ...
          <Image source={{uri:"https://sportzon-cdn.s3.ap-south-1.amazonaws.com/Sportzon-App/Membership/member_corp.png"}}
        ...
        <View style={{padding: 20}}>
          <Text style={{
            ...
            color: '#333',
            marginBottom: 20,
          }}>Perks of Corporate Membership</Text>
          ...
          <View style={{
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
              ...
              <Text style={{fontSize: 16, color: '#666', flex: 1}}>Get Free 45 days extension</Text>
            </View>

            <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
              <Icon name="shirt" size={24} color="#FA8231" style={{marginRight: 15}} />
              <Text style={{fontSize: 16, color: '#666', flex: 1}}>Get 15% off on all Sportzon Merchandise</Text>
            </View>
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
              ...
              <Text style={{fontSize: 16, color: '#666', flex: 1}}>Get premium goodies and gift vouchers that match the value of Corporate Plan</Text>
            </View>
          </View>
            ...
            <Animated.View
              ...
              <View style={{marginBottom: 20}}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  ...
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 4100.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  <Text style={{fontSize: 16, color: '#666'}}>GST (18%)</Text>
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 900.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  <Text style={{fontSize: 16, color: '#666'}}>Gross Amount</Text>
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 5000.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                ...
                <View style={{
                  ...
                  <Text style={{fontSize: 18, fontWeight: 'bold', color: '#333'}}>INR 5000.00</Text>
                </View>
              </View>
...
export default CorporateMembershipScreen;
