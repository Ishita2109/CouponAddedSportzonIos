...
const PlatinumMembershipScreen = ({route}) => {
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#fff'}}>
      <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ backgroundColor: '#6A5ACD', height:250, padding: 20,  position: 'relative' }}>
          ...
          <Image source={{uri:"https://sportzon-cdn.s3.ap-south-1.amazonaws.com/Sportzon-App/Membership/member_plat.png"}}
        ...
        <View style={{padding: 20}}>
          <Text style={{
            ...
            color: '#333',
            marginBottom: 20,
          }}>Perks of Platinum Membership</Text>
          ...
          <View style={{
            ...
            <View style={{flexDirection: 'row', alignItems: 'center', marginBottom: 15}}>
              ...
              <Text style={{fontSize: 16, color: '#666', flex: 1}}>Get premium goodies and gift vouchers that match the value of Platinum Plan</Text>
            </View>
          </View>
            ...
            <Animated.View
              ...
              <View style={{marginBottom: 20}}>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  ...
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 2025.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  <Text style={{fontSize: 16, color: '#666'}}>GST (18%)</Text>
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 450.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                  <Text style={{fontSize: 16, color: '#666'}}>Gross Amount</Text>
                  <Text style={{fontSize: 16, color: '#424242', fontWeight: '500'}}>INR 2500.00</Text>
                </View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between', marginBottom: 10}}>
                ...
                <View style={{
                  ...
                  <Text style={{fontSize: 18, fontWeight: 'bold', color: '#333'}}>INR 2500.00</Text>
                </View>
              </View>
...
export default PlatinumMembershipScreen;